"""
Analysis of OG6_101445 — tRNA-splicing ligase in Archaea and Bacteria.

Selected because of positive ncd1000_host values in both kingdoms.
"""
import numpy as np
import pandas as pd
...
OGCODE = "OG6_101445"  # DNA helicase
...
# %% codecell
colors = {"Archaea": "tab:blue", "Bacteria": "tab:orange"}
g = sns.jointplot(
    data=data,
    x="ncd1000_host",
    y="ncd1000_intein",
...
for k, subset in data.groupby("kingdom"):
    ax.axvline(
        ...
        color=colors[k], linestyle="--", zorder=-1
    )
    ax.axhline(
