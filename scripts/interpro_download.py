#!/usr/bin/env python3
# Script supplied by interpro's API, with slight modifications
...
# modify URL according to dataset of interest
BASE_URL = "https://www.ebi.ac.uk:443/interpro/api/protein/UniProt/entry/InterPro/IPR036844/?page_size=200&extra_fields=sequence"  # noqa
...
def output_list():
    ...
    while next:
        try:
            ...
            sys.stderr.write(sys.stderr.write("LAST URL: " + next))
            raise e
